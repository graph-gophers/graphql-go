...
var metaSrc = `
	...
	# The ` + "`" + `Time` + "`" + ` scalar type represents a single moment in time. Time values are serialized as RFC3339 format strings and can be parsed from RFC3339 strings, Unix timestamps, or Unix timestamps with nanosecond precision.
	scalar Time
